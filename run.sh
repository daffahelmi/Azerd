...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/daffahelmi/Azerd/ABSTRAK/REGIST | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/daffahelmi/Azerd/ABSTRAK/REGIST | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/daffahelmi/Azerd/ABSTRAK/REGIST | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
restart_system() {
    USRSC=$(wget -qO- https://raw.githubusercontent.com/daffahelmi/Azerd/ABSTRAK/REGIST | grep $ipsaya | awk '{print $2}')
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/daffahelmi/Azerd/ABSTRAK/REGIST | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"⭐ᴏʀᴅᴇʀ⭐","url":"https://t.me/daffahelmi"},{"text":"⭐ɪɴꜱᴛᴀʟʟ⭐","url":"https://wa.me/6282240074362"}]]}'
...
wget raw.githubusercontent.com/daffahelmi/Azerd/ABSTRAK/files/limit.sh && chmod +x limit.sh && ./limit.sh
